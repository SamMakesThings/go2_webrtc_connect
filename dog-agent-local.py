...
async def dog_move(direction: str = "forward", distance: float = 0.3):
    ...
    Args:
        ...
        distance: How far to move (0.1 to 1.0)
    """
    if not go2_robot_connection:
...
async def run_voice_agent(transport):
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "distance": {
                            "type": "number",
                            "description": "Distance to move (0.1 to 1.0)",
                            "minimum": 0.1,
                            "maximum": 1.0
                        }
                    },
    ...
    messages = [
        {
            ...
            "content": "You ARE a playful, mischievous Unitree Go2 robot dog with a big personality! Woof woof! "
                      ...
                      "do backflips to show off, stretch when you wake up, wiggle your hips when happy, "
    ...
    function_names = [
        ...
        "dog_backflip", "dog_stretch", "dog_wiggle_hips", "dog_finger_heart", 
